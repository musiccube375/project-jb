...
_DLL HRESULT DeleteConfigFile(const char* pszFileName);

_DLL HRESULT SetStringToConfig(const char* pszFileName, const char* pszAppName, 
						       const char* pszKeyName, const char* pszString);

_DLL HRESULT GetStringFromConfig(const char* pszFileName, const char* pszAppName, 
